...
/**
 * Button variants:
 *   primary   — filled, principal CTA (one per view, ideally)
 *   secondary — filled neutral, supporting action
 *   ghost     — transparent, tertiary / toolbar
 *   outline   — bordered, ambiguous emphasis
 *   destructive — irreversible actions
 *   link      — inline, used in prose
 */
